...
def teacher_dashboard():
    ...
    with tab3:
        ...
        if st.button(
            ...
            key='attendance_records_tab_btn'
        ):
...
def teacher_tab_attendance_records():
    ...
    for r in records:
        ...
        data.append({
            ...
            "Time": (
                pd.to_datetime(ts).strftime("%Y-%m-%d %I:%M %p")
                if ts
                else "N/A"
            ),
